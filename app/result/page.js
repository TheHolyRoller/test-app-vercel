...
function ResultContent() {
  ...
  const audio_url = 'https://fra.cloud.appwrite.io/v1/storage/buckets/dood_gifs/files/6943fe9e00361dad8d36/view?project=67d4d9140008273c9d84&mode=admin';
    ...
    return (
        <>
        <main className={resultStyles.mainContainer} >
            
        <article 
          className={`${resultStyles.card} ${nunito.className}`} 
          id={resultStyles.firstCARD} 
          style={{
          ...
          >
        <div 
          className={resultStyles.cardCategoryColorContainer} 
          style={{
      ...
      >
          ...
          <div className={`${resultStyles.categoryLabelContainer} ${nunito.className}`}    style={{cursor: 'pointer'}} >
              <label className={`${resultStyles.categoryLabel} ${nunito.className}`}>
                  <div className={`${resultStyles.labelContainer} ${nunito.className}`} style={{backgroundColor: '#033699'}} >
                  results
                  </div>
...
<div className={resultStyles.iconBackground} style={{ position: 'absolute', left: '66%', top: '-13px', cursor: 'pointer' }} onClick={toggleUserSound} >
     ...
     {sound === true ? (
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 512 512" style={{ position: 'relative', zIndex: '9999999', opacity: '', fill: '#033699', stroke: '#033699' }} className={resultStyles.soundIcon}  >
            ...
            <path d="M0 0 C5.3985366 5.12494631 8.8992443 10.85325504 12 17.5625 C12.42224854 18.46581055 12.84449707 19.36912109 13.27954102 20.29980469 C20.28361161 35.78290668 24.74510189 52.17499101 27 69 C27.0928125 69.65097656 27.185625 70.30195313 27.28125 70.97265625 C31.8781369 106.50002498 26.20762689 152.76740411 4.1796875 182.453125 C-0.93432797 187.91113254 -6.35120852 190.12788956 -13.8125 190.5 C-20.98180937 190.28465153 -26.77966744 188.2537385 -31.8828125 183.09765625 C-36.45462116 177.34424487 -38.5233546 171.74460489 -38.3046875 164.3828125 C-37.73280934 159.910432 -35.84550838 156.08062408 -34 152 C-18.8110151 117.93886434 -15.06593812 82.71265736 -28.44921875 47.09375 C-30.51384404 41.74616089 -32.67780061 36.47194572 -35.3125 31.375 C-38.19254325 25.6149135 -39.04227963 19.89913042 -37.3515625 13.57421875 C-34.90892075 6.69515503 -31.49512585 1.26373244 -24.828125 -2.09375 C-16.25711969 -5.2857106 -7.80794336 -4.99331521 0 0 Z "  transform="translate(361,163)"/>
                        ...
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="22" height="22"  className={resultStyles.soundIcon} style={{fill: '#033699', stoke: "#033699"}} >
          ...
          <div className={`${resultStyles.question_textContainer} ${nunito.className}`} style={{color:'#333333' }} >
              <h2 className={`${resultStyles.question_text} ${nunito.className}`} style={{color:'#333333' }}>
  
                  <span className={resultStyles.understandSpan} style={{color:'white',}}>
      ...
      <article className={resultStyles.card} id={resultStyles.cardOne}></article>
      <article className={resultStyles.card} id={resultStyles.cardTwo}></article>
      <article className={resultStyles.card} id={resultStyles.cardThree}></article>
      <article className={resultStyles.card} id={resultStyles.cardFour}></article>
